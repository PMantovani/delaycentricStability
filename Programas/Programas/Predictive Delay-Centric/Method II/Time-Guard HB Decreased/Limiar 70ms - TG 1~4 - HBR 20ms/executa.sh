...
do
	...
	do
		...
		clientExpNoRTT $1 396 8000 &
		clientExpNoRTT $2 396 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 384 8000 &
		clientExpNoRTT $2 384 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 372 8000 &
		clientExpNoRTT $2 372 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 360 8000 &
		clientExpNoRTT $2 360 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 348 8000 &
		clientExpNoRTT $2 348 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 336 8000 &
		clientExpNoRTT $2 336 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 324 8000 &
		clientExpNoRTT $2 324 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 312 8000 &
		clientExpNoRTT $2 312 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 300 8000 &
		clientExpNoRTT $2 300 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 288 8000 &
		clientExpNoRTT $2 288 8000 &
	wait
	sleep 1
	...
	do
		...
		clientExpNoRTT $1 264 8000 &
		clientExpNoRTT $2 264 8000 &
	wait
	sleep 1
